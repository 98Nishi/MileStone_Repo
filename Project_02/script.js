  ...
  function createCard(movie) {
    ...
    button.textContent = "Watch Now"; // Set the button text here or modify it as needed
  ...
  function returnMovies(url) {
    fetch(url)
      ...
      .catch(function (error) {
        ...
        const errorMessage = document.createElement("p");
        errorMessage.textContent = "Error fetching movie details. Please try again later.";
        main.appendChild(errorMessage);
      });
  }
